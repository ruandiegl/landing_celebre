...
export function Footer() {
  ...
  return (
    <footer className="relative bg-card/50 border-t border-border/30 py-16">
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        <div className="grid md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-foreground/60 leading-relaxed max-w-sm mb-6">
              Onde fé, celebração e pizza se encontram. Um espaço feito para reunir famílias, 
              grupos de igreja e todos que amam comer bem.
            </p>
          ...
          {/* Quick links */}
          <div>
            <h3 className="font-sans font-bold text-foreground tracking-wider uppercase text-sm mb-4">
              Links Rápidos
            </h3>
        ...
        {/* Bottom */}
        <div className="pt-8 border-t border-border/30 text-center text-sm text-foreground/50">
          <p>&copy; 2024 CELEBRE Pizzaria. Todos os direitos reservados.</p>
        </div>
      </div>
    </footer>
  );
