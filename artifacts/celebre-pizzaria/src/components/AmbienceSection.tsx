...
import diningRoomPath from '../../attached_assets/generated_images/dining-room.jpg';
import ingredientsPath from '../../attached_assets/generated_images/ingredients.jpg';
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-16">
          ...
          >
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-background/60 to-transparent"></div>
            <div className="absolute bottom-6 left-6">
              <h3 className="font-serif text-3xl font-bold text-foreground">Ingredientes Selecionados</h3>
            </div>
          </div>
        </div>
        ...
        >
          ...
          <div className="text-center space-y-3">
            ...
            <h3 className="font-serif text-xl font-bold text-foreground">Ambiente Climatizado</h3>
            <p className="text-foreground/70">Conforto térmico em todas as estações do ano</p>
          </div>
          ...
          <div className="text-center space-y-3">
            ...
            <h3 className="font-serif text-xl font-bold text-foreground">Estacionamento Próprio</h3>
            <p className="text-foreground/70">Vagas gratuitas para nossos clientes</p>
          </div>
        </div>
      </div>
    </section>
